...
#### proxmox ds-0(x) vm node build script ####

# Command to run script on atomic centos vm node
# wget -O - http://192.168.1.10:7777/images/centos/v7.0/scripts/build-ds-01-atomic_node.sh | ash
# wget -O - https://github.com/ahuacate/proxmox/blob/master/scripts/ds-00-atomic_centos.sh | ash
