...
pvesm add nfs cyclone-01-audio --path /mnt/pve/cyclone-01-audio --server 192.168.1.10 --export /volume1/audio --content images --options vers=3
...
pvesm add nfs cyclone-01-books --path /mnt/pve/cyclone-01-books --server 192.168.1.10 --export /volume1/books --content images --options vers=3
...
pvesm add nfs cyclone-01-nextcloud --path /mnt/pve/cyclone-01-nextcloud --server 192.168.1.10 --export /volume1/nextcloud --content images --options vers=4.1
...
pvesm add nfs cyclone-01-transcode --path /mnt/pve/cyclone-01-transcode --server 192.168.1.10 --export /volume1/video/transcode --content images --options vers=3
